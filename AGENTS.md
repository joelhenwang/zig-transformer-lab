...
| 7 — CUDA Backend | **In progress** | PR-α (07bd274), PR-β (3c409a1), PR-γ (be977ea + fix 6b918e6) landed — infrastructure triple (bindings, context, DeviceBuffer) green on RTX 4060 Ti, 12/12 CUDA tests pass, compute-sanitizer clean. Next: PR-δ (Storage.cuda variant). See `docs/stage7_plan.md`. |
| 8–9 | Not started | |
