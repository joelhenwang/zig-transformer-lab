...
| 7 — CUDA Backend | **In progress** | PRs α–λ landed (07bd274 through 52abdf7) — softmax + log_softmax CUDA kernels with oracle fwd+bwd parity; 267/267 CPU + 49/49 CUDA tests pass on RTX 4060 Ti, compute-sanitizer memory-clean. Next: PR-μ (embedding + CE + AdamW). See `docs/stage7_plan.md`. |
| 8–9 | Not started | |
