...
| 7 — CUDA Backend | **In progress** | PR-α (07bd274), PR-β (3c409a1), PR-γ (be977ea + fix 6b918e6), PR-δ (fe269ef) landed — infrastructure triple + Storage.cuda seam closed, 267/267 CPU + 14/14 CUDA tests pass on RTX 4060 Ti, compute-sanitizer clean. Next: PR-ε (Tensor.toCuda / toCpu). See `docs/stage7_plan.md`. |
| 8–9 | Not started | |
